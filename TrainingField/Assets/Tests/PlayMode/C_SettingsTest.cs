...
public class C_SettingsTest
{
    ...
    public IEnumerator ObjectsCheck()
    {
        ...
        eventSystem = PMHelper.Exist("EventSystem");
        ...
        sensSlider = PMHelper.Exist("SensSlider");
        ...
        speedSlider = PMHelper.Exist("SpeedSlider");
